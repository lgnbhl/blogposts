...
pacman::p_load(tidyverse, rvest, sf, countrycode, ggalt, ggthemes, leaflet, RColorBrewer, readxl, rnaturalearth, rnaturalearthdata, rgeos) # hrbrthemes
```
...
url_2016 <- "https://fragilestatesindex.org/wp-content/uploads/data/fsi-2016.xlsx"
# download.file(url = url_2016, destfile = "input/index_2016.xlsx")
index_2016 <- read_excel(path = "mapping/input/index_2016.xlsx")
...
ggplot() +
  ...
  # coord_proj() for Winkel Trimple projection is not working anymore

...
As always the R code is fully reproducible, so you can get it from my [Github repository](https://github.com/lgnbhl/blogposts/tree/master/leaflet-map) or on my online [RStudio Cloud](https://rstudio.cloud/project/800344) session.
